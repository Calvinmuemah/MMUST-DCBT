...
class _AssessmentScreenState extends State<AssessmentScreen> {
  ...
  Future<void> submitAssessment() async {
    ...
    int totalScore = answers.fold(0, (sum, score) => sum + score);
    String level;
    if (totalScore <= 4) {
      level = "Low";
    ...
    final result = await authService.submitOnboarding(
      payload: {
        "answers": payload,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          result["message"] ?? (success ? "Assessment submitted successfully" : "Assessment submission failed"),
        ),
    ...
    if (success) {
      ...
      try {
        ...
        debugPrint("Error updating local onboarding status: $e");
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Mental Assessment"),
      ),
      body: SafeArea(
        child: Padding(
            ...
            children: [
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: selected == index ? AppColors.primary : Colors.white,
                          borderRadius: BorderRadius.circular(18),
                          border: Border.all(
                            color: selected == index ? AppColors.primary : Colors.grey.shade300,
                          ),
                        ),
                        child: Text(
                          options[index],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: selected >= 0 && !isSubmitting ? nextQuestion : null,
