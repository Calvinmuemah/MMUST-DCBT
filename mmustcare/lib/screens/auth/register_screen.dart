...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> handleRegister() async {
    ...
    try {
      ...
      final success = result["token"] != null || result["user"] != null || result["success"] == true;
                          ...
                          child: Column(
                            children: [
                              TextField(
                                ...
                                decoration: inputDecoration(hint: "Full Name", icon: Icons.person_outline),
                              ),
                              ...
                              TextField(
                                ...
                                decoration: inputDecoration(hint: "Referral Code (Optional)", icon: Icons.card_giftcard),
                              ),
